...
namespace AQUAS
{
    public class AQUAS_UnderWaterEffect : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            background.GetComponent<Camera>().cullingMask = GetComponent<Camera>().cullingMask;
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            if (other.gameObject.name == "Static Boundary")
            {
                ...
                volumeMask.GetComponent<AQUAS_VolumeMask>().waterObj = other.transform.parent.gameObject;

                frontFaceMask.GetComponent<AQUAS_FrontFaceMask>().waterObj = other.transform.parent.gameObject;

                background.GetComponent<AQUAS_CaptureBackground>().waterObj = other.transform.parent.gameObject;
            }
            else
            {
