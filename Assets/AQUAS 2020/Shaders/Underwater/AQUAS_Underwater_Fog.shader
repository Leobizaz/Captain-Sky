	...
	SubShader
	{
		...
		#define UNITY_SETUP_STEREO_EYE_INDEX_POST_VERTEX(input)
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float2 lerpResult144 = lerp( float2( 0,0 ) , (( saturate( ( tex2DNode155.r + tex2DNode155.g + tex2DNode155.b ) ) * tex2D( _DropletNormals, uv_DropletNormals ) )).rg , lerp(0.0,( tex2DNode143.r * ( 1.0 - step( 0.95 , tex2DNode143.r ) ) ),_EnableWetLens));
				...
				float clampDepth12 = Linear01Depth(SAMPLE_DEPTH_TEXTURE_PROJ(_CameraDepthTexture,UNITY_PROJ_COORD( screenPos )));
