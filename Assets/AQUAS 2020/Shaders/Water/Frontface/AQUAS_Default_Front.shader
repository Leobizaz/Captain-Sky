Shader "AQUAS/Desktop/Front/Default"
{
	Properties
	{
		...
		[Header(Reflection Options)][Toggle]_EnableRealtimeReflections("Enable Realtime Reflections", Float) = 0
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float2 appendResult1_g286 = (float2(waveSpeed675 , 0.0));
			...
			float2 panner3_g286 = ( _Time.y * appendResult1_g286 + rotator30);
			float normalStrength681 = _NormalStrength;
			float3 lerpResult67 = lerp( float3(0,0,1) , ( UnpackNormal( tex2D( _NormalTexture, panner3_g293 ) ) + UnpackNormal( tex2D( _NormalTexture, panner3_g286 ) ) ) , normalStrength681);
			...
			float4 screenColor86_g303 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_GrabTexture,( (ase_screenPosNorm).xy + ( float2( 0.2,0 ) * refraction511 ) ));
			float3 LightWrapVector47_g303 = (( _LightWrapping * 0.5 )).xxx;
			float2 appendResult1_g291 = (float2(waveSpeed675 , 0.0));
			...
			float2 panner3_g291 = ( _Time.y * appendResult1_g291 + temp_output_1324_0);
			float2 appendResult1_g287 = (float2(waveSpeed675 , 0.0));
			...
			float2 panner3_g287 = ( _Time.y * appendResult1_g287 + rotator1327);
			float3 lerpResult1333 = lerp( float3(0,0,1) , ( UnpackNormal( tex2D( _NormalTexture, panner3_g291 ) ) + UnpackNormal( tex2D( _NormalTexture, panner3_g287 ) ) ) , normalStrength681);
			...
			float4 ShorelineNormal817 = ( float4( lerpResult824 , 0.0 ) * ( 1.0 - step( tex2DNode912.r , _ShorelineBlend ) ) * ( ( tex2D( _RandomMask, panner3_g244 ) + tex2D( _RandomMask, panner3_g242 ) ) / 2.0 ) );
			...
			float2 appendResult1_g288 = (float2(temp_output_678_0 , 0.0));
			...
			float2 panner3_g288 = ( _Time.y * appendResult1_g288 + rotator630);
			...
			float3 lerpResult639 = lerp( float3(0,0,1) , ( UnpackNormal( tex2D( _NormalTexture, panner3_g292 ) ) + UnpackNormal( tex2D( _NormalTexture, panner3_g288 ) ) ) , normalStrengthMedium706);
			float3 WavesMediumUv1640 = lerpResult639;
			float temp_output_1362_0 = ( waveSpeed675 / 10.0 );
			float2 appendResult1_g289 = (float2(temp_output_1362_0 , 0.0));
			...
			float2 panner3_g289 = ( _Time.y * appendResult1_g289 + temp_output_1360_0);
			float2 appendResult1_g290 = (float2(temp_output_1362_0 , 0.0));
			...
			float2 panner3_g290 = ( _Time.y * appendResult1_g290 + rotator1361);
			float3 lerpResult1367 = lerp( float3(0,0,1) , ( UnpackNormal( tex2D( _NormalTexture, panner3_g289 ) ) + UnpackNormal( tex2D( _NormalTexture, panner3_g290 ) ) ) , normalStrengthMedium706);
			...
			float2 appendResult1_g295 = (float2(temp_output_680_0 , 0.0));
			float2 temp_output_1201_0 = ( BaseUV1197 * ( normalTiling618 / 1200.0 ) );
			float2 panner3_g295 = ( _Time.y * appendResult1_g295 + temp_output_1201_0);
			float2 appendResult1_g296 = (float2(temp_output_680_0 , 0.0));
			...
			float2 panner3_g296 = ( _Time.y * appendResult1_g296 + rotator646);
			...
			float3 lerpResult657 = lerp( float3(0,0,1) , ( UnpackNormal( tex2D( _NormalTexture, panner3_g295 ) ) + UnpackNormal( tex2D( _NormalTexture, panner3_g296 ) ) ) , normalStrengthFar704);
			...
			float3 appendResult4_g299 = (float3(( ( (lerpResult670.rgb).xy * NormalSign1123 ) + WorldNormalXZ1122 ) , WorldNormalY1121));
			float3 ase_worldTangent = WorldNormalVector( i, float3( 1, 0, 0 ) );
			float3 ase_worldBitangent = WorldNormalVector( i, float3( 0, 1, 0 ) );
			float3x3 ase_worldToTangent = float3x3( ase_worldTangent, ase_worldBitangent, ase_worldNormal );
			float3 worldToTangentDir = normalize( mul( ase_worldToTangent, (appendResult4_g299).xzy) );
			...
			float3 CurrentNormal23_g303 = normalize( (WorldNormalVector( i , appendResult735 )) );
			#if defined(LIGHTMAP_ON) && UNITY_VERSION < 560 //aseld
			float3 ase_worldlightDir = 0;
			#else //aseld
			float3 ase_worldlightDir = normalize( UnityWorldSpaceLightDir( ase_worldPos ) );
			#endif //aseld
			float dotResult20_g303 = dot( CurrentNormal23_g303 , ase_worldlightDir );
			float NDotL21_g303 = dotResult20_g303;
			#if defined(LIGHTMAP_ON) && ( UNITY_VERSION < 560 || ( defined(LIGHTMAP_SHADOW_MIXING) && !defined(SHADOWS_SHADOWMASK) && defined(SHADOWS_SCREEN) ) )//aselc
			float4 ase_lightColor = 0;
			#else //aselc
			float4 ase_lightColor = _LightColor0;
			#endif //aselc
			float3 AttenuationColor8_g303 = ( ase_lightColor.rgb * ase_lightAtten );
			...
			float2 appendResult1_g301 = (float2(_FoamSpeed , 0.0));
			float3 temp_output_21_0_g300 = ase_worldNormal;
			float temp_output_17_0_g300 = (temp_output_21_0_g300).y;
			float2 appendResult18_g300 = (float2(sign( temp_output_17_0_g300 ) , 1.0));
			float2 temp_output_1212_0 = ( ( appendResult18_g300 * (ase_worldPos).xz ) * _FoamTiling );
			float2 panner3_g301 = ( _Time.y * appendResult1_g301 + temp_output_1212_0);
			float2 appendResult1_g302 = (float2(_FoamSpeed , 0.0));
			...
			float2 panner3_g302 = ( _Time.y * appendResult1_g302 + rotator296);
			float3 desaturateInitialColor304 = ( tex2D( _FoamTexture, panner3_g301 ) - tex2D( _FoamTexture, panner3_g302 ) ).rgb;
			...
			float clampResult100_g303 = clamp( ase_worldlightDir.y , ( length( (UNITY_LIGHTMODEL_AMBIENT).rgb ) / 3.0 ) , 1.0 );
			float3 diffuseColor131_g303 = ( ( ( max( ( LightWrapVector47_g303 + ( ( 1.0 - LightWrapVector47_g303 ) * NDotL21_g303 ) ) , float3(0,0,0) ) * AttenuationColor8_g303 ) * foamyWater490.rgb ) * clampResult100_g303 );
			float3 normalizeResult77_g303 = normalize( ase_worldlightDir );
			float3 normalizeResult28_g303 = normalize( ( normalizeResult77_g303 + ase_worldViewDir ) );
			float3 HalfDirection29_g303 = normalizeResult28_g303;
			float dotResult32_g303 = dot( HalfDirection29_g303 , CurrentNormal23_g303 );
			float SpecularPower14_g303 = exp2( ( ( _Gloss * 10.0 ) + 1.0 ) );
			...
			float3 specularFinalColor42_g303 = ( AttenuationColor8_g303 * pow( max( dotResult32_g303 , 0.0 ) , SpecularPower14_g303 ) * specularity504.rgb );
			float3 diffuseSpecular132_g303 = ( diffuseColor131_g303 + specularFinalColor42_g303 );
			...
			float4 lerpResult87_g303 = lerp( screenColor86_g303 , float4( diffuseSpecular132_g303 , 0.0 ) , opacity508);
			c.rgb = ( lerpResult87_g303 * ase_lightAtten ).rgb;
			c.a = 1;
			return c;
		}
