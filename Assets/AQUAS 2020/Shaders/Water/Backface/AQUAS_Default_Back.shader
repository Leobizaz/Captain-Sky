Shader "AQUAS/Desktop/Back/Default Back"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			float2 appendResult1_g264 = (float2(waveSpeed675 , 0.0));
			...
			float2 panner3_g264 = ( _Time.y * appendResult1_g264 + rotator1327);
			float3 lerpResult1333 = lerp( float3(0,0,1) , ( UnpackNormal( tex2D( _NormalTexture, panner3_g261 ) ) + UnpackNormal( tex2D( _NormalTexture, panner3_g264 ) ) ) , normalStrength681);
			...
			float2 appendResult1_g265 = (float2(temp_output_678_0 , 0.0));
			...
			float2 panner3_g265 = ( _Time.y * appendResult1_g265 + temp_output_1347_0);
			...
			float3 lerpResult639 = lerp( float3(0,0,1) , ( UnpackNormal( tex2D( _NormalTexture, panner3_g265 ) ) + UnpackNormal( tex2D( _NormalTexture, panner3_g263 ) ) ) , normalStrengthMedium706);
			...
			float2 panner3_g270 = ( _Time.y * appendResult1_g270 + temp_output_1201_0);
			...
			float2 panner3_g271 = ( _Time.y * appendResult1_g271 + rotator646);
			...
			float3 lerpResult657 = lerp( float3(0,0,1) , ( UnpackNormal( tex2D( _NormalTexture, panner3_g270 ) ) + UnpackNormal( tex2D( _NormalTexture, panner3_g271 ) ) ) , normalStrengthFar704);
